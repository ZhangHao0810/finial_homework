...
import com.zhanghao.finalHomework.model.NewestCompInfo;
...
public class AdminLoginViews {
     ...
     * <p>
     * 展示最新比赛信息 String compName, Long teacherId
     * <p>
     * 最新比赛信息 分页查询
     */
    ...
    public String adminIndex(Model model) {
        ...
        List<NewestCompInfo> newestCompInfos = compService.listNewestCompInfos();

        model.addAttribute("infos", newestCompInfos);
