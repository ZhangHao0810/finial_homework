...
/** 2019/12/6 9:58
 * 这个工具类模拟了codegen插件,可以直接生成dao，model和对应的xml文件
*/
...
public class EntityUtil {
	...
	private final String moduleName = "final_homework"; // 数据库名称

	private final String bean_path = "d:\\DATA\\mybatistest\\bean\\";

	private final String mapper_path = "d:\\DATA\\mybatistest\\mapper\\";

	private final String xml_path = "d:\\DATA\\mybatistest\\xml\\";// xml路径

	private final String model_package = "com.zhanghao.finalHomework.model";// model的包所在

	private final String dao_package = "com.zhanghao.finalHomework.dao";// dao的包所在

	private final String driverName = "com.mysql.jdbc.Driver";

	private final String user = "root";// 数据库用户

	private final String password = "0206";// "root";//数据库密码

	private final String url = "jdbc:mysql://127.0.0.1:3306/final_homework?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false";
